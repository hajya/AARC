...
def getHomologues(blast_records, searchQuery, proteinName):
    ...
    #blast_results_abnormal = False
    for alignment in blast_records.alignments:
        #More hsps seem to just contain info on the alignment, not useful to us
        #if (len(alignment.hsps) != 1) and not blast_results_abnormal: #ERROR CONDITION
        #    blast_results_abnormal = True;
        #    print >> sys.stderr, "ERROR: unexpected blast results for: " + searchQuery[0:100] 
        #    continue
